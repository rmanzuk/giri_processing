% Script containing the code to produce final figures for branching
% morphology data
%
% Ryan A. Manzuk03/23/2021
%% Any 3d data 2d projection (Figure 3)
% change these for the data you want to use
data_3d = outlines_3d; 
data_pixel_scale = 1;
center_statistics = center_stats;
...
%% make a bunch of box & whisker plots (Figure 3)
figure()
subplot(2,1,1)

% and trail data based upon previously published statistics
...
% compile all to feed into boxplot
...
%% time series of stromatolite and then archaeo and coral data (Figure 4)
...
%% Branch angle histograms (not used)
...
%% weighted least squares branching radius and spacing (not used) 
